...
import lv.velexauto.velex.database.hibernate.CommonMetodsDAOImpl;
...
public class DBConnection {
    ...
    protected void initDatabaseConnectionProperties() {
        Properties properties = new Properties();
        try {
            properties.load(CommonMetodsDAOImpl.class.getClassLoader().getResourceAsStream(DB_CONFIG_FILE));
